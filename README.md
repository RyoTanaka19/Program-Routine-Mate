...
[Program-Routine-Mate]は、Web 上で初学者がプログラミング学習を他のユーザーと共有、楽しみながら習慣化できるサービスです。
...
- 1つずつ着実に学びながらプログラミング学習を習慣化したい初学者の人
  ...
  (例 プログラミング言語(Ruby など)、フレームワーク(RubyonRails など)、HTML、CSS、JavaScript、SQL、git、 Docker)など、たくさん学習することがあります。
...
- 楽しくプログラミング学習を継続したい初学者の人
  - 学習記録を投稿するでは、モチベーションが上がらないと思われるので、学習継続によるバッジを獲得、学習継続のランキング戦、学習記録から AI が問題を提供など
...
- 3週間(21 日)ごとに新しい取り組み(ジャンル)を追加できる。
