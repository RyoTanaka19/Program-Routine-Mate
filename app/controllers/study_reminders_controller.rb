  ...
  def create
    ...
    if @study_reminder.save
      begin
        ...
        flash[:alert] = t("study_reminders.create.notification_schedule_failed")
      end

      respond_to do |format|
        format.turbo_stream do
          flash.now[:notice] = t("study_reminders.create.set_times_success")
          render :create
        end
        format.html do
          flash[:notice] ||= t("study_reminders.create.set_times_success")
